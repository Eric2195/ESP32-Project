/*
 * font.h — 8x16 bitmap font (ASCII 0x20-0x7E)
 * Standard VGA/CP437 font, 16 bytes per glyph, MSB = leftmost pixel
 */
#pragma once
...
/* 95 printable ASCII characters (0x20 space .. 0x7E tilde) */
